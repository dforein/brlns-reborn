...
public class MMCommand extends Command {
    ...
    public boolean execute(CommandSender sender, String commandLabel, String[] args) {
        ...
        switch (args[0].toLowerCase()) {
            ...
            case "setrules":
                ...
                server.setDefaultGamemode(Player.SPECTATOR);
    ...
    private boolean handleMapCommand(Player player, String[] args) {
        ...
        if (args.length < 2) {
            ...
            player.sendMessage(TextFormat.GRAY + "/mm map remove <mapName> <x1> <y1> <z1> <x2> <y2> <z2>");
        ...
        switch (subCmd) {
            ...
            case "add":
                ...
                try {
                    ...
                    mapper.addVolume(map, pos1, pos2, player.getLevel(), player);
                } catch (NumberFormatException e) {
                    player.sendMessage(TextFormat.RED + "Invalid coordinates!");
                }
                return true;
