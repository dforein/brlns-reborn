...
public class ScoreboardSystem extends ScoreboardAbstract {
    ...
    public void updatePregame(Player player, String timer) {
        ...
        drawPregame(sb, player.getUniqueId(), timer);
    }
    ...
    public void updateInGame(Player player, String timer, int innocents, boolean sheriffAlive, MMRole role) {
        ...
        drawInGame(sb, player.getUniqueId(), timer, innocents, sheriffAlive, role);
    }

    private void drawInGame(Scoreboard sb, UUID playerId, String timer, int innocents, boolean sheriffAlive, MMRole role) {
        int score = 0;
        String[] lines = {
            "&a",
            "  &l&aInnocents:",
        ...
        clearUnusedLines(sb, playerId, score);
    }
